...
const Page = () => {
  return (
    <div className="w-full min-h-screen text-white relative overflow-hidden overflow-x-hidden">
      ...
      <BackgroundBeams />
      <Header />
      <div className="w-full h-[800px] z-[5] mt-5 lg:mt-0 absolute overflow-y-hidden overflow-x-hidden">
        <div className="w-[450px] lg:w-[800px] md:w-[600px] mx-auto bg-black/40 mb-10 absolute z-[1] outfit-font bg-opacity-100 border-zinc-900 border-[1px] rounded-lg overflow-hidden left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2">
